...
namespace GameEngine
{
	namespace Render::HAL
	{
		...
		Mesh::Ptr D3D12RHI::CreatePyramideMesh()
		{

			array<Vertex, 5> vertices =
			{
				Vertex({ Math::Vector3f(-1.0f, 0.0f, -1.0f), Math::Vector4f((float*)&DirectX::Colors::White) }),
				Vertex({ Math::Vector3f(+1.0f, 0.0f, -1.0f), Math::Vector4f((float*)&DirectX::Colors::Red) }),
				Vertex({ Math::Vector3f(+1.0f, 0.0f, +1.0f), Math::Vector4f((float*)&DirectX::Colors::Green) }),
				Vertex({ Math::Vector3f(-1.0f, 0.0f, +1.0f), Math::Vector4f((float*)&DirectX::Colors::Blue) }),
				Vertex({ Math::Vector3f(0.0f, 1.8f, 0.0f), Math::Vector4f((float*)&DirectX::Colors::Yellow) })
			};
