...
namespace GameEngine::World
{
	std::unordered_map<ComponentParser::ComponentName, ComponentParser::ComponentConstructor> ComponentParser::s_CustomComponentConstructors =
	{
		...
		{"JumpSoundPtr", [](const ComponentValue& value) { return reinterpret_cast<uint64_t>(Core::g_AudioEngine.LoadSound(Core::g_FileSystem->GetFilePath(value).generic_string().c_str())); }},
	};
